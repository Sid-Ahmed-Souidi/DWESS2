...
<legend>Crear pelicula</legend>
    ...
    <br>
    <input type="text" name="tituloPagina" placeholder="la momia">
    <br><br>
    <label>Fecha de registro</label>
    <br/>
    <input type="date" name="fechaRegistro" value="<?php echo date('Y-m-d')?>"/>         
    <br>
    <label>Genero</label>
            <br/>
    ...
    <input type="number" name="numeroCapitulos">
    <br><br>
