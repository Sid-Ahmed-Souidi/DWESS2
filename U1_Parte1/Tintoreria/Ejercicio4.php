...
<label for="tipo">Tipo</label><br>
    <select name="tipo" id="tipo">
        ...
        <!--Si tipo no enviado o sin valor para tipo es igual a textil , entonces textil se marca como seleccionada-->
...
if(isset($_POST['guardar'])){
    ...
    if(!isset($error)){
        ...
        $t = new Trabajo($_POST['fecha'],$_POST['nombre'], $_POST['tipo'] , implode('/' ,$_POST['servicios']), $_POST['importe']);
